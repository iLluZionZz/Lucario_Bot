...
module.exports = {
    ...
    async execute (client, message, args, Discord){  
        if(message.content.includes("@everyone") || message.content.includes("@here") || message.content.includes("@member"))  return // if the message content includes @everyone OR ( || means or in js) @here, stop running the code. 
